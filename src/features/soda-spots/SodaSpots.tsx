...
import { useEffect, useRef, useState, PropsWithChildren, Children } from "react";
import React from "react";
import { getApp } from "firebase/app";
import { collection, GeoPoint, getDocs, getFirestore, query } from "firebase/firestore";
...
function SodaSpots() {
    ...
    useEffect(() => {
        ...
        allSodaSpotsDetails.then((value) => {
    ...
    return (
        <Wrapper apiKey="AIzaSyCmqXemln5UJb7BkFS4h_KTsAycFxR-H0c">
            <Map style={{ width: '50%', height: '300px'}} zoom={3} center={{lat: 0, lng: 0}}>
